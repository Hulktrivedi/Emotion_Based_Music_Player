...
connectiondb = pymysql.connect(host="localhost",user="root",passwd="",database="registerdb")
...
def login():
    ...
    Label(root2, text='Please Enter your Account Details', bd=5,font=('arial', 12, 'bold'), relief="groove", fg="black",
    ...
    Label(root2, text="").pack()
    Button(root2, text="Login", bg="blue", fg='black', relief="groove", font=('arial', 12, 'bold'),command=login_verification).pack()
    Label(root2, text="")
...
def logged():
    ...
    Button(logged_message, text="Logout", bg="blue", fg='black', relief="groove", font=('arial', 12, 'bold'), command=logged_destroy).pack()
...
def main_display():
    ...
    root.title(" Admin  Login System")
    root.geometry("500x500")
    Label(root,text='Welcome to Admin log In System',  bd=20, font=('arial', 20, 'bold'), relief="groove", fg="black",
                   bg="blue",width=300).pack()
